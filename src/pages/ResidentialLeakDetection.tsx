...
const faqs = [
  ...
  { q: "What areas do you serve for residential leak detection?", a: <p><Link to="/pool-service-peabody-ma" style={{ color: "var(--teal)" }}>Peabody</Link>, <Link to="/pool-service-danvers-ma" style={{ color: "var(--teal)" }}>Danvers</Link>, <Link to="/pool-service-middleton-ma" style={{ color: "var(--teal)" }}>Middleton</Link>, <Link to="/pool-service-beverly-ma" style={{ color: "var(--teal)" }}>Beverly</Link>, <Link to="/pool-service-salem-ma" style={{ color: "var(--teal)" }}>Salem</Link>, <Link to="/pool-service-saugus-ma" style={{ color: "var(--teal)" }}>Saugus</Link>, <Link to="/pool-service-lynnfield-ma" style={{ color: "var(--teal)" }}>Lynnfield</Link>, and surrounding North Shore communities. Call <a href="tel:9788825932" style={{ color: "var(--teal)" }}>(978) 882-5932</a> for availability in your area.</p> },
];
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))", gap: 20, marginTop: 40 }}>
            {detectCards.map((item, i) => (
              <div key={i} style={{ background: "var(--white)", border: "1px solid var(--fog)", borderRadius: 14, padding: "28px 24px" }}>
                ...
                <p style={{ fontSize: 14, color: "var(--stone)", lineHeight: 1.6 }}>{item.desc}{item.title === "Pool & Spa Equipment" && <> We also offer dedicated <Link to="/leak-detection" style={{ color: "var(--teal)", fontWeight: 600 }}>pool leak detection</Link> for full system diagnostics.</>}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="sec">
        <div className="wrap">
          ...
          <div style={{ marginTop: 32, padding: "24px 28px", background: "linear-gradient(135deg, var(--teal), var(--pool))", borderRadius: 14, color: "#fff" }}>
            <p style={{ fontSize: 15, lineHeight: 1.7, margin: 0 }}>For larger pipe failures where epoxy lining isn't sufficient, we also offer full <Link to="/trenchless-pipe-repair" style={{ color: "#fff", fontWeight: 600, textDecoration: "underline" }}>trenchless pipe replacement</Link> using pipe bursting and relining methods — still no excavation, still done in a day.</p>
          </div>
        </div>
      </section>
        ...
        <div className="wrap">
          <div className="content-block">
            <div className="content-block__text">
              ...
              <p>Based in <Link to="/pool-service-peabody-ma" style={{ color: "var(--teal)", fontWeight: 600 }}>Peabody, MA</Link> and serving homeowners across <Link to="/pool-service-danvers-ma" style={{ color: "var(--teal)", fontWeight: 600 }}>Danvers</Link>, <Link to="/pool-service-beverly-ma" style={{ color: "var(--teal)", fontWeight: 600 }}>Beverly</Link>, <Link to="/pool-service-salem-ma" style={{ color: "var(--teal)", fontWeight: 600 }}>Salem</Link>, <Link to="/pool-service-lynnfield-ma" style={{ color: "var(--teal)", fontWeight: 600 }}>Lynnfield</Link>, <Link to="/pool-service-marblehead-ma" style={{ color: "var(--teal)", fontWeight: 600 }}>Marblehead</Link>, and the entire North Shore. <Link to="/locations" style={{ color: "var(--teal)", fontWeight: 600 }}>See all service areas →</Link></p>
            </div>
          </div>
        </div>
      </section>
